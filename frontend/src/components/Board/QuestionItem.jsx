  ...
  return (
    <div className="border rounded mb-4 p-4">
      <div className="mb-2">
        ...
        <p className="text-gray-700 whitespace-pre-line mt-1">{question.content}</p>
      ...
      {question.comment ? (
        <div className="mt-4 border-t pt-3 text-sm bg-gray-50 p-3 rounded">
          ...
          <p className="text-gray-700 mt-1 whitespace-pre-line">{question.comment.content}</p>
        ...
        <>
          ...
          {showCommentForm && (
            <CommentBox questionId={question._id} onFinish={refresh} onClose={toggleForm} />
          )}
        </>
      ) : (
