...
//         reset: resetRegister,
//         formState: { errors: registerErrors }, // ✅ 추가
//     } = useForm({ mode: "onChange" });
    ...
    <div className="w-screen h-screen m-0 p-0 overflow-hidden bg-white font-[Montserrat] relative flex">
      ...
      >
        ...
        >
          ...
          />
          {registerErrors.name && <p className="text-red-500 text-sm mt-1">{registerErrors.name.message}</p>}
          ...
          <input
            ...
            className="bg-white border border-[#00C4C4] px-4 py-2 w-full max-w-[300px] mt-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#00C4C4]"
          />
          {registerErrors.confirmPassword && <p className="text-red-500 text-sm mt-1">{registerErrors.confirmPassword.message}</p>}
