...
// import FaqWritePage from "./pages/FaqWritePage"; // 이 파일은 별도 생성해야 함
...
//                     <Route path="/admin/board" element={<BoardSection />} /> {/* ✅ 질문게시판 관리 */}
//                     <Route path="/admin/faq-write" element={<FaqWritePage />} /> {/* ✅ FAQ 작성 페이지 */}
//                 </Route>
//             </Route>
//         </Routes>
//     );
